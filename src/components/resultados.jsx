...
class Resultados extends Component {
    state = { 
        results: [
            { concurso: 2551, date: '04/01/2022', d1: 25, d2: 43, d3: 46, d4: 48, d5: 1, d6: 29 },
    ...
    render() { 
        ...
        for (let i = 0; i < this.state.results.length; i++) {
            ...
            rows.push(
                <Row id={"linha_" + this.state.results[i].concurso} key={i}>
                    <Col id={ "concurso_" + this.state.results[i].concurso }>{ this.state.results[i].concurso }</Col>
                    <Col id={ "data_sorteio_" + this.state.results[i].concurso }>{ this.state.results[i].date }</Col>
                    <Col id={ "dezena1_" + this.state.results[i].concurso }>{ this.state.results[i].d1 }</Col>
                    <Col id={ "dezena2_" + this.state.results[i].concurso }>{ this.state.results[i].d2 }</Col>
                    <Col id={ "dezena3_" + this.state.results[i].concurso }>{ this.state.results[i].d3 }</Col>
                    <Col id={ "dezena4_" + this.state.results[i].concurso }>{ this.state.results[i].d4 }</Col>
                    <Col id={ "dezena5_" + this.state.results[i].concurso }>{ this.state.results[i].d5 }</Col>
                    <Col id={ "dezena6_" + this.state.results[i].concurso }>{ this.state.results[i].d6 }</Col>
                </Row>
            );
        }
        // console.log(rows);
        return (
            <Container fluid id="div_concursos" className="grid-striped">
                <Row id="linha_titulos">
                    <Col id="concurso">Núm</Col>
                    <Col id="data">Data</Col>
                    <Col id="dezena1">D1</Col>
                    <Col id="dezena2">D2</Col>
                    <Col id="dezena3">D3</Col>
                    <Col id="dezena4">D4</Col>
                    <Col id="dezena5">D5</Col>
                    <Col id="dezena6">D6</Col>
                </Row>
                {rows}
            </Container>
        );
